...
Widget buildGraphArea(BuildContext context) {
  ...
  final interval = (maxY / 7).ceilToDouble(); // 5 intervals for y-axis
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              left: 8,
              top: 0,
              bottom: 40, // Bottom titles area height
              child: Container(
                width: 40,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: List.generate(6, (index) {
                    final value = maxY - (interval * index);
                    return Text(
            ...
            // Scrollable graph area (shifted to right)
            Positioned(
              left: 50, // Make space for y-axis labels
              top: 0,
              right: 0,
              bottom: 0,
